...
triangle (west)) - see https://wiki.geogebra.org/en/SetPointStyle_Command for the full list
...
xref:/SetPerspective_Command.adoc[SetPerspective Command] for the string interpretation.
