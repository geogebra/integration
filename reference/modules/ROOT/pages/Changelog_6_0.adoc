...
== [#6.0.836.0_.2826th_March_2024_build.29]#6.0.836.0 (26th March 2024 build)#
...
== [#6.0.832.0_.2812th_March_2024_build.2C_unreleased.29]#6.0.832.0 (12th March 2024 build, unreleased)#

* Scripting: re-enable support for case-insensitive command names
* Classic 5: fix for fonts in Thai, Kannada languages

== [#6.0.830.0_.285th_March_2024_build.29]#6.0.830.0 (5th March 2024 build)#
...
== [#6.0.829.0_.2828th_February_2024_build.29]#6.0.829.0 (28th February 2024 build)#
...
== [#6.0.827.0_.2820th_February_2024_build.29]#6.0.827.0 (20th February 2024 build)#

* fix `++IsInRegion()++` for 3D conics

== [#6.0.826.0_.2813th_February_2024_build.29]#6.0.826.0 (13th February 2024 build)#

* fix scripting problem eg in French with `++Inter(l1,l2)++`
* make sure brackets kept for editing vectors ie `++a*(b*c)++`

== [#6.0.825.0_.287th_February_2024_build.29]#6.0.825.0 (7th February 2024 build)#
...
== [#6.0.823.0_.2830th_January_2024_build.29]#6.0.823.0 (30th January 2024 build)#
...
== [#6.0.820.0_.289th_January_2024_build.29]#6.0.820.0 (9th January 2024 build)#
...
== [#6.0.819.0_.283rd_January_2024_build.29]#6.0.819.0 (3rd January 2024 build)#
...
== [#6.0.817.0_.286th_December_2023_build.29]#6.0.817.0 (6th December 2023 build)#
...
== [#6.0.814.0_.2821st_November_2023_build.29]#6.0.814.0 (21st November 2023 build)#
...
== [#6.0.813.0_.2814th_November_2023_build.29]#6.0.813.0 (14th November 2023 build)#
...
== [#6.0.811.0_.2831st_October_2023_build.29]#6.0.811.0 (31st October 2023 build)#
...
== [#6.0.810.0_.2825th_October_2023_build.29]#6.0.810.0 (25th October 2023 build)#
...
== [#6.0.807.0_.2817th_October_2023_build.29]#6.0.807.0 (17th October 2023 build)#
...
== [#6.0.806.0_.2811th_October_2023_build.29]#6.0.806.0 (11th October 2023 build)#
...
== [#6.0.805.0_.284th_October_2023_build.29]#6.0.805.0 (4th October 2023 build)#
...
== [#6.0.804.0_.2826th_September_2023_build.29]#6.0.804.0 (26th September 2023 build)#
...
== [#6.0.803.0_.2819th_September_2023_build.29]#6.0.803.0 (19th September 2023 build)#

* Exam mode shown in header
* fix for dynamic absolute position
* fix randomization in files with unlabeled polygons

== [#6.0.802.0_.2812th_September_2023_build.29]#6.0.802.0 (12th September 2023 build)#

* new exam mode for Vlaanderen region
* updated colors for buttons
* fix for "zoomed in keyboard" on iPhone

== [#6.0.801.0_.287th_September_2023_build.29]#6.0.801.0 (7th September 2023 build)#
...
== [#6.0.799.0_.2826th_August_2023_build.29]#6.0.799.0 (26th August 2023 build)#

* fix memory leak with Polygons in `++Sequence()++`
* Make sure Ctrl-Z doesn't work in applets
* CAS: fix for `++x(A)++`

== [#6.0.794.0_.281st_August_2023_build.29]#6.0.794.0 (1st August 2023 build)#

* new method `++ggbApplet.isInteractive()++`

== [#6.0.793.0_.2825th_July_2023_build.29]#6.0.793.0 (25th July 2023 build)#

* bugfixes

== [#6.0.791.0_.2811th_July_2023_build.29]#6.0.791.0 (11th July 2023 build)#

* Better cleanup on `++ggbApplet.remove()++`

== [#6.0.790.0_.286th_July_2023_build.29]#6.0.790.0 (6th July 2023 build)#

* fix for saving in offline apps
* Scientific: Table View added

== [#6.0.787.2F788.0_.2827th_June_2023_build.29]#6.0.787/788.0 (27th June 2023 build)#

* `++<Ctrl>O++` in Algebra View / Input Boxes to enter recurring decimals
* bugfix: make sure π is exact in CAS

== [#6.0.785.0_.2820th_June_2023_build.29]#6.0.785.0 (20th June 2023 build)#
...
== [#6.0.783.0_.2813th_June_2023_build.29]#6.0.783.0 (13th June 2023 build)#
...
== [#6.0.782.0_.286th_June_2023_build.29]#6.0.782.0 (6th June 2023 build)#

* parentheses now available on the ABC keyboard tab

== [#6.0.781.0_.2830th_May_2023_build.29]#6.0.781.0 (30th May 2023 build)#
...
== [#6.0.779.0_.2816th_May_2023_build.2C_not_released.29]#6.0.779.0 (16th May 2023 build, not released)#

* fix "Selection allowed" checkbox for multiple objects
* CAS: fix for `++¬a++`

== [#6.0.778.0_.2810th_May_2023_build.29]#6.0.778.0 (10th May 2023 build)#
...
== [#6.0.776.0_.282nd_May_2023_build.29]#6.0.776.0 (2nd May 2023 build)#

* improvement for eg `++6048 * (1/3)++`
* `++||++` as shortcut for Logical OR (`++∨++`) now works in web apps

== [#6.0.775.0_.2825th_April_2023_build.29]#6.0.775.0 (25th April 2023 build)#

* new scripting tab "On Drag-end"
* new scripting tab "On Change" for Input Boxes only

== [#6.0.774.0_.2818th_April_2023_build.29]#6.0.774.0 (18th April 2023 build)#
...
== [#6.0.772.0_.284th_April_2023_build.29]#6.0.772.0 (4th April 2023 build)#

* bugfix: make sure fixed lists can't be moved with the keyboard eg `++{(1,2)}++`

== [#6.0.770.0_.2829th_March_2023_build.29]#6.0.770.0 (29th March 2023 build)#
...
== [#6.0.766.0_.2814th_March_build.29]#6.0.766.0 (14th March build)#

* Fix for `++Zip()++`

== [#6.0.764.0_.2810th_March_build.29]#6.0.764.0 (10th March build)#

* {blank}

== [#6.0.762.0_.2828th_February_2023_build.2C_ChromeOS_only.29]#6.0.762.0 (28th February 2023 build, ChromeOS only)#
...
== [#6.0.760.0_.287th_February_2023_build.29]#6.0.760.0 (7th February 2023 build)#
...
== [#6.0.759.0_.2831st_January_2023_build.29]#6.0.759.0 (31st January 2023 build)#

* Optimise plotting for eg `++sin(x^x)++`
* Option to change the style of vector arrows
* fix bug with eg `++h SetValue(list,{{a},{a}})++`

== [#6.0.755.2F756.0_.2817th_January_2023_build.29]#6.0.755/756.0 (17th January 2023 build)#
...
== [#6.0.754.0_.2810th_January_2023_build.29]#6.0.754.0 (10th January 2023 build)#

* fix for dragging `++Point(list)++`
* fix for on-screen keyboard in Table view

== [#6.0.753.0_.283rd_January_2023_build.29]#6.0.753.0 (3rd January 2023 build)#
...
== [#6.0.752.0_.2820th_December_2022_build.29]#6.0.752.0 (20th December 2022 build)#

* Classic 6: fix problem with copy/paste in spreadsheet
* add "y-increment" for points

== [#6.0.751.0_.2813th_December_2022_build.29]#6.0.751.0 (13th December 2022 build)#

* CAS: Distance() command added
* New default Button style

== [#6.0.748.2F749.0_.286th.2F7th_December_2022_build.29]#6.0.748/749.0 (6th/7th December 2022 build)#
...
== [#6.0.745.0_.2816th_November_2022_build.29]#6.0.745.0 (16th November 2022 build)#

* fix plotting glitch for eg `++-1 / tan²(x) - 1++`

== [#6.0.744.0_.2814th_November_2022_build.29]#6.0.744.0 (14th November 2022 build)#
...
== [#6.0.742.0_.282nd_November_2022_build.29]#6.0.742.0 (2nd November 2022 build)#

* fix problem with `++FitPoly(l1, 1)++`
* new default axes colour

== [#6.0.741.0_.2828th_October_2022_build.29]#6.0.741.0 (28th October 2022 build)#
...
== [#6.0.739.0_.2823rd_October_2022_build.29]#6.0.739.0 (23rd October 2022 build)#
...
== [#6.0.736.0_.2811th_October_2022_build.29]#6.0.736.0 (11th October 2022 build)#

* clean up unused WebGL contexts
* fix update of dependencies when dragging >code>\{Polygon(...)}

== [#6.0.735.0_.284th_October_2022_build.29]#6.0.735.0 (4th October 2022 build)#

* Suite: *Probability Calculator sub-app added for iOS and Android*

== [#6.0.734.0_.2829th_September_2022_build.29]#6.0.734.0 (29th September 2022 build)#

* Classic 6: fix for spreadsheet editing on iOS

== [#6.0.732.0_.2820th_September_2022_build.29]#6.0.732.0 (20th September 2022 build)#

* fix for Shading for `++Integral(f, a, b, false)++`

== [#6.0.731.0_.2813th_September_2022_build.29]#6.0.731.0 (13th September 2022 build)#

* small fixes

== [#6.0.730.0_.2830th_August_2022_build.29]#6.0.730.0 (30th August 2022 build)#

* more SVG icons added to default button images

== [#6.0.729.0_.2825th_August_2022_build.29]#6.0.729.0 (25th August 2022 build)#
...
== [#6.0.726.0_.289th_August_2022_build.29]#6.0.726.0 (9th August 2022 build)#

* new style for selected Points
* Old Input Boxes now have "keyboard" icon for the full keyboard rather then the old "*α*" icon

== [#6.0.724.2F725.0_.282nd_August_2022_build.29]#6.0.724/725.0 (2nd August 2022 build)#
...
== [#6.0.723.0_.2826th_July_2022_build.29]#6.0.723.0 (26th July 2022 build)#

* 3D: fix Show/Hide grid button

== [#6.0.722.0_.2819th_July_2022_build.29]#6.0.722.0 (19th July 2022 build)#

* HTML5: fix for extra spurious digits when rounding

== [#6.0.721.0_.2812th_July_2022_build.29]#6.0.721.0 (12th July 2022 build)#

* CAS: fix for `++Solve({a k=1,a ℯ^(3 k)=3 ℯ},{a,k})++`
* Data Table improvements
* fix for full-screen icon on touch

== [#6.0.720.0_.285th_July_2022_build.29]#6.0.720.0 (5th July 2022 build)#

* New command `++NIntegral(function, start x, start y, end x)++` to calculate and plot a numerical integral

== [#6.0.718.0_.2822nd_June_2022_build.29]#6.0.718.0 (22nd June 2022 build)#
...
== [#6.0.715.0_.2814th_June_2022_build.29]#6.0.715.0 (14th June 2022 build)#

* fix for SetFilling()

== [#6.0.713.0_.288th_June_2022_build.29]#6.0.713.0 (8th June 2022 build)#

* new command `++Type(Conic/Quadric)++`
* fix zooming jitter with 2 Views

== [#6.0.709.0_.2824th_May_2022_build.29]#6.0.709.0 (24th May 2022 build)#
...
== [#6.0.700.0_.286th_April_2022_build.29]#6.0.700.0 (6th April 2022 build)#
...
== [#6.0.696.2F697.0_.2829th_March_2022_build.29]#6.0.696/697.0 (29th March 2022 build)#

* fix plotting of eg `++4x³ - 12x² > 0++`
* Classic 6: fix problem with transparent burger menu

== [#6.0.695.0_.2822th_March_2022_build.29]#6.0.695.0 (22th March 2022 build)#

* Classic 5: sign-in removed

== [#6.0.694.0_.2815th_March_2022_build.29]#6.0.694.0 (15th March 2022 build)#

* fix crashing with pen strokes

== [#6.0.693.0_.288th_March_2022_build.29]#6.0.693.0 (8th March 2022 build)#
...
== [#6.0.691.0_.2823rd_February_2022_build.29]#6.0.691.0 (23rd February 2022 build)#

* fixes for drawing quadrics
* fix for dilating circles

== [#6.0.689.0_.2815th_February_2022_build.29]#6.0.689.0 (15th February 2022 build)#

* Notes: Isometric and Polar grids

== [#6.0.688.0_.288th_February_2022_build.29]#6.0.688.0 (8th February 2022 build)#

* bug fixes

== [#6.0.687.0_.281st_February_2022_build.29]#6.0.687.0 (1st February 2022 build)#

* iOS: Image Tool added
* CAS: PerpendicularVector(plane) syntax added

== [#6.0.686.0_.2825th_January_2022_build.29]#6.0.686.0 (25th January 2022 build)#
...
== [#6.0.683.0_.287th_January_2022_build.29]#6.0.683.0 (7th January 2022 build)#
...
== [#6.0.680.0_.288th_December_2021_build.29]#6.0.680.0 (8th December 2021 build)#
...
== [#6.0.678.0_.2830th_November_2021.29]#6.0.678.0 (30th November 2021)#
...
== [#6.0.677.0_.2823rd_November_2021_build.29]#6.0.677.0 (23rd November 2021 build)#
...
== [#6.0.676.0_.2816th_November_2021_build.29]#6.0.676.0 (16th November 2021 build)#
...
== [#6.0.675.0_.289th_November_2021_build.29]#6.0.675.0 (9th November 2021 build)#
...
== [#6.0.674.0_.282nd_November_2021_build.29]#6.0.674.0 (2nd November 2021 build)#

* fix for `++Solve({x * y = 1,3*x^2 = y^2},{x,y})++`
* Classic 5: fix for some CAS Calculations eg Numeric(), FitPoly() (Windows)

== [#6.0.672.0_.2819th_October_2021_build.29]#6.0.672.0 (19th October 2021 build)#
...
== [#6.0.671.0_.2812th_October_2021_build.29]#6.0.671.0 (12th October 2021 build)#
...
== [#6.0.670.0_.287th_October_2021_build.29]#6.0.670.0 (7th October 2021 build)#
...
== [#6.0.668.0_.2829th_September_2021_build.29]#6.0.668.0 (29th September 2021 build)#
...
== [#6.0.666.0_.2821st_September_2021_build.29]#6.0.666.0 (21st September 2021 build)#
...
== [#6.0.665.0_.2814th_September_2021_build.29]#6.0.665.0 (14th September 2021 build)#

* CAS: make sure "random" commands work again
* fixes for `++ggbApplet.remove()++`

== [#6.0.664.0_.287th_September_2021_build.29]#6.0.664.0 (7th September 2021 build)#

* fix problem with Box Plot label position

== [#6.0.662.0_.2826th_August_2021_build.29]#6.0.662.0 (26th August 2021 build)#

* Classic 6: fix for Ctrl-C/V/A in scripting dialogs
* new command `++IsFactored( <Polynomial> )++`
* small Probability Calculator fixes

== [#6.0.659.0_.2810th_August_2021_build.29]#6.0.659.0 (10th August 2021 build)#
...
== [#6.0.657.0_.2827th_July_2021_build.29]#6.0.657.0 (27th July 2021 build)#
...
== [#6.0.656.0_.2820th_July_2021_build.29]#6.0.656.0 (20th July 2021 build)#
...
== [#6.0.654.0_.2815th_July_2021_build.29]#6.0.654.0 (15th July 2021 build)#
...
== [#6.0.652.0_.286th_July_2021_build.29]#6.0.652.0 (6th July 2021 build)#
...
== [#6.0.650.2F651.0_.2829th.2F30th_June_2021_build.29]#6.0.650/651.0 (29th/30th June 2021 build)#
...
== [#6.0.649.0_.2822nd_June_2021_build.29]#6.0.649.0 (22nd June 2021 build)#

* Notes: new Mindmaps Tool and Charts improvements
* improvement for eg `++FormulaText(sin(1x + 1x - 1x))++`
* CAS: fix for eg `++mod(3^5431843, 2)++`

== [#6.0.648.0_.2815th_June_2021_build.29]#6.0.648.0 (15th June 2021 build)#
...
== [#6.0.647.0_.288th_June_2021_build.29]#6.0.647.0 (8th June 2021 build)#

* Classic 6: fix for scrollwheel in spreadsheet

== [#6.0.645.2F646.0_.284th_June_2021_build.29]#6.0.645/646.0 (4th June 2021 build)#
...
== [#6.0.643.2F644.0_.2825th.2F26th_May_2021_build.29]#6.0.643/644.0 (25th/26th May 2021 build)#
...
== [#6.0.640.0_.2827th_April_2021_build.29]#6.0.640.0 (27th April 2021 build)#

* fix style bar in Safari

== [#6.0.638.2F639.0_.2820th_April_2021_build.29]#6.0.638/639.0 (20th April 2021 build)#
...
== [#6.0.637.0_.2813th_April_2021_build.29]#6.0.637.0 (13th April 2021 build)#

* Geometry: fix Rigid Polygon Tool/command
* fix for plotting `++arcosh(x)++`

== [#6.0.636.0_.286th_April_2021_build.29]#6.0.636.0 (6th April 2021 build)#
...
== [#6.0.558.0_.28iOS_only.29]#6.0.558.0 (iOS only)#

* CAS Calculator: fixes for eg f(x)=

== [#6.0.556.2F7.0]#6.0.556/7.0#
...
== [#6.0.551.0_.28not_released_yet.29]#6.0.551.0 (not released yet)#
...
== [#6.0.501.0_.28not_released_yet.29]#6.0.501.0 (not released yet)#
